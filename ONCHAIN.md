...
## Verified — live at the on-chain tier (10)
...
| Algorand testnet | `algoexplorer-dispenser` | `Z5GPJQCHVU54C2I4FLYNE2XHRQRL5OV2GPJQKXJFMW34CRIN2KRQFXF7DI` | 12,298 ALGO · 0d. Via Algonode algod (balance) + indexer (recency). |
...
- **Algorand** (Algonode algod for balance + indexer for recency): `algorand-testnet`.
